...
public class InventoryController {
	...
	@PostMapping
	public ResponseEntity<InventoryDto> createInventory(@RequestBody CreateInventoryDto createInventoryDto) {
		InventoryDto savedInventory = inventoryService.createInventory(createInventoryDto);
