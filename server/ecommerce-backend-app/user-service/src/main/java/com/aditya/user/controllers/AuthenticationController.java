...
public class AuthenticationController {
	...
	public ResponseEntity<LoginResponse> authenticate(@RequestBody LoginUserDto loginUserDto) {
		...
		LoginResponse loginResponse = new LoginResponse().setToken(jwtToken).setRefreshToken(refreshToken.getRefreshToken())
	...
	public LoginResponse refreshToken(@RequestBody RefreshTokenRequest refreshTokenRequest) {
		return refreshTokenService.findByRefreshToken(refreshTokenRequest.getRefreshToken()).map(refreshTokenService::verifyExpiration)
